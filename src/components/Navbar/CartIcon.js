...
export default function Cart() {
  ...
  return (
    <div>
      <p>Click me</p>
      <a className='h-8 w-8 relative' href='/cart'>
        <Image src={cart} alt='cart' />
        <div className='h-2 w-2 p-3 rounded-full bg-black text-white flex items-center justify-center absolute -top-3 -right-1'>
