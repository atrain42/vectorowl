  ...
  return (
    <div className='px-8 mb-40'>
      ...
      <div className='hire-landing flex flex-col items-center justify-center mv:mt-16 md:mt-32'>
        ...
        <button
          className='mt-20 text-center rounded px-8 py-4 text-black w-48 text-md tracking-wider font-poppins bg-white border border-black cursor-pointer mv:hover:none md:hover:scale-105 transition-all ease-in duration-50 mv:mx-auto sm:mx-0'
          id='hire-btn'
      ...
      <div className='flex flex-col justify-center items-center mb-12 mt-80'>
        <h1 className='text-4xl text-center mb-4 mv:w-full sm:w-100'>
        ...
        <p className='text-center mv:w-full sm:w-500'>
          ...
          we&#39;ve got you covered. We make custom illustrations that are
          tailored to your{' '}
          <span className='text-secondary font-semibold'>brand</span>{' '}
          <span className='text-theme font-semibold'>colors.</span> Setting your
          website apart from the competition starts here.
        </p>
      ...
      <div
        className='flex flex-col justify-center items-center mb-12 mt-80'
        ref={ref}
        id='reference'
      >
        <h1 className='text-4xl text-center mb-4 mv:w-full sm:w-100'>
