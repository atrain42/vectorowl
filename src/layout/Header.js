    ...
    <header className='flex items-center mv:px-8 mv:flex-col-reverse mv:justify-center mv:pt-8 md:flex-row md:justify-evenly md:pt-20'>
      <div className='mv:mr-0 mv:w-full md:mr-4 md:w-100'>
        ...
        <p className='mt-5 text-lg w-full'>
          At HollowBox, we create unique vector art that will separate your
        ...
        <div className='grid grid-cols-2 mt-8 gap-x-9 gap-y-9 font-button place-items-center text-lg tracking-wider'>
          <a
            className='w-full rounded text-center py-4 bg-theme text-white border border-black hover:scale-102 active:scale-95 transition-all ease-in duration-50'
            href='/illustrations'
          >
            Illustrations
          </a>
          <Link
            className='w-full rounded text-center py-4 border bg-offwhite border-black hover:scale-102 active:scale-95 transition-all ease-in duration-50'
            href='/about'
          >
            About us
          </Link>
